...
static void usage(FILE *stream) {
  fprintf(stream,
          "Usage: lnc_registered_pair [options] ref.fit target.fit out.fit\n"
          "\n"
          "Options:\n"
...
#ifndef LNC_REGISTERED_STANDARD_MAIN
#define LNC_REGISTERED_STANDARD_MAIN main
#endif

int LNC_REGISTERED_STANDARD_MAIN(int argc, char **argv) {
  ...
  LncFitsMetadata metadata = {
      ...
      .value_scale = "adu",
      .background_estimator = LNC_BACKGROUND_ESTIMATOR,
